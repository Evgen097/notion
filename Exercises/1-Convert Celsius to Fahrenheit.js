'use strict';
// The algorithm to convert from Celsius to Fahrenheit is the
// temperature in Celsius times 9/5, plus 32.
//
// You are given a variable celsius representing a temperature in Celsius.
//   Use the variable fahrenheit already defined and assign
// it the Fahrenheit
...
// be covered in future challenges. For now, only use operators
// that you have already learned.
const convert = degrees => {
  const farengDegree = (degrees * 1.8) + 32;
  const rounded = Math.floor(farengDegree);
  return rounded;
};
